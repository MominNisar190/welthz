...
export async function generateMonthlyReport(transactions, month, year) {
  ...
  const reportData = transactions.map((transaction) => ({
    ...
    Amount: (transaction.type === "INCOME" ? "+" : "-") + transaction.amount.toFixed(2) + " RS",
  ...
  reportData.push({
    ...
    Category: "",
    "Transaction Type": "",
    Amount: "+" + totalIncome.toFixed(2) + " RS",
    Recurring: "",
  });
  reportData.push({
    Date: "Total Expense",
    ...
    Category: "",
    "Transaction Type": "",
    Amount: "-" + totalExpense.toFixed(2) + " RS",
    Recurring: "",
  });
  reportData.push({
    Date: "Net Balance",
    ...
    Category: "",
    "Transaction Type": "",
    Amount: (netBalance >= 0 ? "+" : "-") + Math.abs(netBalance).toFixed(2) + " RS",
    Recurring: "",
  });
